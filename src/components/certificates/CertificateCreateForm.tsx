...
export default function CertificateCreateForm({ defaults }: { defaults: any }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <ComponentCard title="Certificate Configuration" desc="Enter domain and metadata for your new certificate">
